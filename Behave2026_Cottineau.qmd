...
author: "Clémentine Cottineau-Mugadza | Behave Summer School"
editor: visual
format: 
  revealjs: 
    theme: moon
...
- It is reproduced through the unequal resources, networks and preferences of individuals of different sociodemographic groups, through the (constrained) decision to move and where to relocate [@krysan2017cycle] [@deluca2020not]

- Segregation itself produces social inequalities through contextual eﬀects across life domains [@tammaru2021spatial]

## Vicious cycle/circles of segregation

![](pres_files/viciouscircles.png)

Source: [@tammaru2021spatial]
...
![](figures/Hyeji.png)  ![](figures/hyeji_gen.png)
Source: [@hyejimaster]

## Synthetic cities {.scrollable}

![](figures/Q1Q4.png){width="90%"}
Source: [@hyejimaster]

## Space and sensitivity {.scrollable}

![](figures/spacematters1.png){width="90%"}
Source: [@raimbault2019space]

## Space and sensitivity {.scrollable}

![](figures/spacematters2.png){width="75%"}
Source: [@raimbault2019space]
...
::::: {layout-ncol="2"}
::: {}
![](figures/spacematters5.png){width="35%"}

Relative distance of phase diagrams as function of generator parameters α (preferential attachment) and β (diffusion), i.e. the average squared distance between corresponding points of the phase diagrams in the isotropic and generated setyps. **Values greater than 1 will mean that inter-diagram variability is more important than intra-diagram variability**. 
:::
...
[![](pres_files/qr_cdvw3.png){width="45%"}](https://clementinecttn.github.io/Behave2026/Behave2026_Cottineau)
